...
module.exports = class extends Generator {
  ...
  async initializing() {
    if (!Object.keys(this.options).includes('skipVersionCheck')) {
      ...
      //     [
      //       'ls-remote',
      //       'git@github.com:philips-internal/acpmp-microfrontend-generators.git',
      //       'master',
      //     ],
      //     {
      //       cwd: __dirname,
      ...
      //     );
      //     console.warn(
      //       `${CONSTANTS.ERROR} npm i -g git+ssh://git@github.com:philips-internal/acpmp-microfrontend-generators.git ${CONSTANTS.NOCOLOR}`,
      //     );
      //     console.warn(
      //       `${CONSTANTS.ERROR} ------------------------------------------ ${CONSTANTS.NOCOLOR}`,
      //     );
